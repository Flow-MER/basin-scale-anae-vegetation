...
from dask.distributed import Client as DaskClient, LocalCluster, wait as dask_wait
...
def start_dask():
    ...
    logger.info(f"Dashboard: http://127.0.0.1:{config.DASK_DASHBOARD_PORT}")
